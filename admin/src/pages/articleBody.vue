  ...
  watch: {
    id() {
      ...
      getArticle(params).then(res => {
        if (res.status) {
          this.formData.title = res.goods.article_title;
          this.formData.kindId = res.goods.kind_id;
          this.formData.homeShow = Boolean(res.goods.home_show);
          this.formData.description = res.goods.description;
          this.formData.content = res.goods.content;
          this.formData.coverUrl = res.goods.cover_img;
          this.formData.content = res.goods.content;
        } else {
